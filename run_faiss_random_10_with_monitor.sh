...
REPORT_DIR="reports/faiss_random_10_${TS}"
...
echo "============================================================"
echo "10 RANDOM FAISS IHALE - CANLI TEST + SISTEM IZLEME"
echo "============================================================"
...
echo "[TEST] 10 FAISS ihale karar testi baslatiliyor..."
echo
...
summary = f"""
============================================================
10 FAISS RANDOM IHALE - SISTEM KAYNAK OZETI
============================================================
